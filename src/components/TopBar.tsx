  ...
  return (
    <div className="topbar" data-tauri-drag-region>
      ...
      <div className="seg view-seg" data-dir={segDir} role="radiogroup" aria-label="视图切换">
        ...
        <button type="button" disabled={channelOn} aria-pressed={view === "preset"} onClick={() => onViewChange("preset")}>
          <Tags size={13} />
          语义视图
        </button>
        <button type="button" aria-pressed={view === "advanced"} onClick={() => onViewChange("advanced")}>
