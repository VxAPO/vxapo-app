export const en: Record<string, string> = {
  ...
  "error.timeout": "Operation timed out. Try again (the elevation prompt may still be waiting).",
  "error.elevation": "Could not start elevation (declined or blocked by the system).",
  "error.script": "Failed to write the elevation script (temp directory not writable?).",
  "error.cliSpawn": "Could not launch vxapo-cli (check the installation, or set VXAPO_CLI).",
  "error.cliParse": "Unparsable vxapo-cli output (version mismatch?).",
  "error.cliWait": "Failed while waiting for vxapo-cli to exit.",
  "error.operation": "Operation failed.",
  "error.install": "Installation failed.",
  "error.installThread": "Install worker crashed.",
  "error.installNoResult": "Installation ended without a result event.",
  "error.lang": "Invalid language value.",
  "ch.L": "Left",
  "ch.R": "Right",
  "ch.C": "Center",
  "ch.LFE": "LFE",
  ...
  "stale.migrate.title": "Migrate stale GUID record",
  "stale.migrate.confirm": "Migrate old records to {name}?\n\nConfig: {config}\nSnapshot: {snapshot}\nMode: {mode}",
  "stale.migrate.done": "Stale GUID records migrated",
  "stale.cleanup.done": "Stale GUID records cleaned",
  "stale.settings.name": "Stale GUID records",
  "stale.settings.desc": "{count} stale record(s) not matched to a device",
  ...
  "disable.device": "Disable device tuning",
  "enable.device": "Enable device tuning",
